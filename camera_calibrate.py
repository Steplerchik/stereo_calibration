...
class StereoCalibration(object):
    def __init__(self, gl_left, gl_right):
...
#         self.cal_path = filepath
        ...
        self.read_images(gl_left, gl_right)

    def read_images(self, gl_left, gl_right):
        images_right = gl_right
        images_left = gl_left
        images_left.sort()
        images_right.sort()
...
#             if ret_r is True:
        ...
        print('len(self.objpoints):', len(self.objpoints))
        print('len(self.imgpoints_l):', len(self.imgpoints_l))
        print('self.objpoints[0].shape:', self.objpoints[0].shape)
        print('len(self.imgpoints_l):', self.imgpoints_l[0].shape)
